export const KAIRO_TRANSLATE_IDS = {
  ...
  ADDON_SETTING_REQUIRED_ACTIVATION_BODY:
    "kairo.addonSetting.required.activation.body",
  ADDON_SETTING_REQUIRED_DEACTIVATION_BODY:
    "kairo.addonSetting.required.deactivation.body",
  ADDON_SETTING_REQUIRED_ACTIVE_CONFIRM:
    "kairo.addonSetting.required.active.confirm",
  ADDON_SETTING_REQUIRED_DEACTIVE_CONFIRM:
    "kairo.addonSetting.required.deactive.confirm",
